...
- docs: storage-adapter inheritance contract + correct the hasStorageMethod story (07754d1)
...
### [7.19.5](https://github.com/soulcraftlabs/brainy/compare/v7.19.4...v7.19.5) (2026-02-19)
...
* remove src/cortex/ directory and fix README claims ([36db644](https://github.com/soulcraftlabs/brainy/commit/36db644eca94253f1df04a1f91968856ac585b36))
